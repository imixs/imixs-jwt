...
public class JWTBuilderTest {
    ...
    public void setup() {
        ...
        token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE1NzgyMTg2Nzg5OTIsInN1YiI6IjEyMzQ1Njc4OTAiLCJuYW1lIjoiSm9obiBEb2UiLCJhZG1pbiI6dHJ1ZX0.ujX9a3mbNIq2-z3_5tam0UujZCSaJQKYe43av2xnIzI";
    }
    ...
    public void testSignatureJSON() throws JWTException {
        ...
        Assert.assertEquals("ujX9a3mbNIq2-z3_5tam0UujZCSaJQKYe43av2xnIzI", builder.getSignature());
    ...
    public void testJSONWebTokenWithIat() throws JWTException {
        ...
        JWTBuilder builder = new JWTBuilder().setKey(secretKey).setHeader(header).setPayload(payload_without_iat)
                .sign();
        ...
        String iat_payload = new JWTParser().setKey(secretKey).setToken(iat_token).verify().getPayload();
